...
tokenz = open(pickle_path + 'conf_neutrontok.pickle','rb')
tokens = pickle.load(tokenz)
tokenz.close()

log_data_f = open(pickle_path + 'conf_neutron.pickle','rb')
log_data = pickle.load(log_data_f)
log_data_f.close()

feature_sets_f = open(pickle_path + 'conf_neutronfs.pickle','rb')
feature_sets = pickle.load(feature_sets_f)
feature_sets_f.close()

classifier_f = open(pickle_path + "conf_nbneutron.pickle","rb")
classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_mnbneutron.pickle","rb")
MultinomialNB_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_bnbneutron.pickle","rb")
BernoulliNB_classifier = pickle.load(classifier_f)
classifier_f.close()
 
classifier_f = open(pickle_path + "conf_sgdneutron.pickle","rb")
SGDClassifier_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_lsvcneutron.pickle","rb")
