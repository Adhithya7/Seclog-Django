...
opfile_path = template_path + 'output_cinder.txt'
...
#stdin,stdout,stderr=ssh.exec_command('sudo cat /var/log/cinder/api.log', get_pty= True)		#path to file cinder log	
stdin,stdout,stderr=ssh.exec_command('sudo cat ~/testcinder.log', get_pty= True)
time.sleep(2)
stdin.write(spass + '\n')
stdin.flush()
time.sleep(5)
...
#stdin,stdout,stderr=ssh.exec_command('sudo cat /var/log/cinder/backup.log', get_pty= True)		#path to file cinder log	
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#stdin,stdout,stderr=ssh.exec_command('sudo cat /var/log/cinder/cinder-manage.log', get_pty= True)		#path to file cinder log	
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#stdin,stdout,stderr=ssh.exec_command('sudo cat /var/log/cinder/scheduler.log', get_pty= True)		#path to file cinder log	
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#stdin,stdout,stderr=ssh.exec_command('sudo cat /var/log/cinder/volume.log', get_pty= True)		#path to file cinder log	
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
with open(template_path + 'cin_svfile.txt','r+') as fin1:
    if os.stat(template_path + 'cin_svfile.txt').st_size == 0:
        m1 = hashlib.md5()
        fh_enc = str(fh[1:])
        i=0
        while True:
        ...
        output = open(template_path + 'cin_check.txt','w+')  
