...
tokenz = open(pickle_path + 'conf_novatok.pickle','rb')
tokens = pickle.load(tokenz)
tokenz.close()

log_data_f = open(pickle_path + 'conf_nova.pickle','rb')
log_data = pickle.load(log_data_f)
log_data_f.close()

feature_sets_f = open(pickle_path + 'conf_novafs.pickle','rb')
feature_sets = pickle.load(feature_sets_f)
feature_sets_f.close()

classifier_f = open(pickle_path + "conf_nbnova.pickle","rb")
classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_mnbnova.pickle","rb")
MultinomialNB_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_bnbnova.pickle","rb")
BernoulliNB_classifier = pickle.load(classifier_f)
classifier_f.close()
 
classifier_f = open(pickle_path + "conf_sgdnova.pickle","rb")
SGDClassifier_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "conf_lsvcnova.pickle","rb")
