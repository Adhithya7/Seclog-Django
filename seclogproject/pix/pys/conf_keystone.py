...
tokenz = open(pickle_path + 'conf_keystonetok.pickle','rb')
tokens = pickle.load(tokenz)
tokenz.close()

log_data_f = open(pickle_path + 'conf_keystone.pickle','rb')
log_data = pickle.load(log_data_f)
log_data_f.close()

feature_sets_f = open(pickle_path + 'conf_keystonefs.pickle','rb')
feature_sets = pickle.load(feature_sets_f)
feature_sets_f.close()

classifier_f = open(pickle_path + 'conf_nbkeystone.pickle',"rb")
classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + 'conf_mnbkeystone.pickle',"rb")
MultinomialNB_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + 'conf_bnbkeystone.pickle',"rb")
BernoulliNB_classifier = pickle.load(classifier_f)
classifier_f.close()
 
classifier_f = open(pickle_path + 'conf_sgdkeystone.pickle',"rb")
SGDClassifier_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + 'conf_lsvckeystone.pickle',"rb")
