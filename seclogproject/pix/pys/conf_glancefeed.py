...
opfile_path = template_path + 'conf_output_glance.txt'
...
stdin,stdout,stderr=ssh.exec_command('sudo cat ~/testgl.conf', get_pty= True)
#stdin,stdout,stderr=ssh.exec_command('sudo cat /etc/glance/glance-api.conf', get_pty= True)		#path to file glance-api.conf
time.sleep(2)
stdin.write(spass + '\n')
stdin.flush()
time.sleep(5)
...
#ssh.connect(hostname='%s' %host, username='%s' %uname, pkey=key, timeout=10)				
#stdin,stdout,stderr=ssh.exec_command('sudo cat /etc/glance/glance-cache.conf', get_pty= True)		#path to file glance-cache.conf
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#ssh.connect(hostname='%s' %host, username='%s' %uname, pkey=key, timeout=10)				
#stdin,stdout,stderr=ssh.exec_command('sudo cat /etc/glance/glance-registry.conf', get_pty= True)	#path to file glance-registry.conf
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#ssh.connect(hostname='%s' %host, username='%s' %uname, pkey=key, timeout=10)
#stdin,stdout,stderr=ssh.exec_command('sudo cat /etc/glance/glance-scrubber.conf', get_pty= True)	#path to file glance-scrubber.conf
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
...
#ssh.connect(hostname='%s' %host, username='%s' %uname, pkey=key, timeout=10)
#stdin,stdout,stderr=ssh.exec_command('sudo cat /etc/glance/rootwrap.conf', get_pty= True)		#path to file rootwrap.conf
#time.sleep(2)
#stdin.write(spass + '\n')
#stdin.flush()
#time.sleep(5)
