...
token_data_f = open(pickle_path + 'tokencinder.pickle','rb')
tokens = pickle.load(token_data_f)
token_data_f.close()

log_data_f = open(pickle_path + 'logcinder.pickle','rb')
log_data = pickle.load(log_data_f)
log_data_f.close()

feature_sets_f = open(pickle_path + 'cinderfs.pickle','rb')
feature_sets = pickle.load(feature_sets_f)
feature_sets_f.close()

classifier_f = open(pickle_path + "nbcinder.pickle","rb")
classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "mnbcinder.pickle","rb")
MultinomialNB_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "bnbcinder.pickle","rb")
BernoulliNB_classifier = pickle.load(classifier_f)
classifier_f.close()
 
classifier_f = open(pickle_path + "sgdcinder.pickle","rb")
SGDClassifier_classifier = pickle.load(classifier_f)
classifier_f.close()

classifier_f = open(pickle_path + "lsvccinder.pickle","rb")
